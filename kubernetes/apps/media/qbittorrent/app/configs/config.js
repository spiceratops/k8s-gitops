...
module.exports = {
  ...
  dataDirs: [
    "/media-data/downloads/torrents/complete/sonarr",
    "/media-data/downloads/torrents/complete/radarr",
    "/media-data/downloads/torrents/complete/manual",
  ],

  linkType: "hardlink",
  linkDir: "/media-data/downloads/torrents/complete/xseed",
